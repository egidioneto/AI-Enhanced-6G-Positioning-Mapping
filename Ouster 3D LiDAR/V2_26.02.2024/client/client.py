...
#! Code to send script to raspberry:
# scp client\client.py raspberrypi@192.168.0.101:~/Desktop/
...
def send_function(data, host, port, measure_speed=False, chunk_size=1024):
  ...
  try:
    ...
    print(f'\nTrying to send data | Size {total_size} bytes')
...
print("Starting to take readings...")
